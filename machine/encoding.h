...
#define V5_MCACHE_CTL_L1L_PREFETCH_OFFSET      9
...
#define V5_MCACHE_L1D_WBINVAL_ALL 6
...
#define V5_MCACHE_CTL_L1L_PREFETCH_EN  (1UL << V5_MCACHE_CTL_L1L_PREFETCH_OFFSET)
